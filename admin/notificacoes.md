...
::: info
Hoje a única opção disponível nesta tela é **Cadastro Incompleto**. Não existe opção de notificar quem "nunca acessou" o app.
:::
...
| Alistamento pendente (falta voto em PvP) | O jogador pendente |
| Alistamento pendente ou rejeitado por presença em PvP | O jogador afetado |
| Alistamento pendente por estar fora da janela "PvP Ativo" | O jogador afetado |
| Alistamento pendente por estar fora da janela "Escalação BC" | O jogador afetado |
| Alistamento pendente ou rejeitado por estar na blacklist do clã | O jogador afetado |
| Bloqueio temporário por troca recente do personagem principal | O jogador afetado |
| Alistamento pendente aguardando revisão (se o clã tiver "Notificar coordenador pendente" ativado) | Gerenciadores de Clã |
| Alistamento automático desativado por erro | Admins |
| Login no Painel falhou 5 vezes | Admins |
