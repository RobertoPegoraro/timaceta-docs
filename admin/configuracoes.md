...
**Campo:** `Alistamento manual ativado`

Ativa ou desativa a funcionalidade de alistamento manual no app (a opção de enviar pedido pelo app diretamente).
...
Username da conta do clã no Instagram (sem o @). Exibido como link na seção de redes sociais.
