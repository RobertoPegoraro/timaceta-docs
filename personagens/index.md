...
3. Preencha todos os campos — veja a descrição completa em [Cadastrar / Editar Personagem](/personagens/campos)
4. Toque em **Salvar**
...
1. Vá em **Personagens**
2. Toque no personagem desejado
...
## Múltiplos personagens (Alts e Piloto)
...
## Buscar personagem de outro membro

Qualquer usuário pode buscar informações de um personagem pelo nick:

1. Vá em **Personagens** → **Buscar**
2. Digite o nick
3. O sistema exibe as informações e o usuário vinculado
